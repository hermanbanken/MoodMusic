...
/**
 * Corresponds to an FFTW <code>rfftw_plan</code> (plan
 * for real one dimensional transforms) structure.

 * A plan is a choice of algorithm to optimally compute
 * transforms
 for a given length of data. Once you have a
 * <code>Plan</code>
...
{
/**
 * I store <code>rfftw_plan</code> (the pointer) in this
 ...
 * <code>rfftw_create_plan_specific</code> for
 more insight.)
 ...
 * behind it is <code>rfftw_one</code>.)
 * @return the resulting array which is of the same size as
 <code>in</code>.
 ...
 * <p>(See FFTW documentation for details. The function
 * behind it is <code>rfftw</code>, the arguments are
 * mapped to
 <code>rfftw</code>'s arguments of the same name.)
 * @throws IndexOutOfBoundsException if <code>in</code>
 or <code>out</code>
