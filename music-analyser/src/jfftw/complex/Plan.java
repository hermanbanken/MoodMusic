...
/**
 * Corresponds to an FFTW <code>fftw_plan</code> (plan
 ...
 * <code>fftw_create_plan_specific</code> for
 more insight.)
...
/**
 * Constructs a <code>Plan</code> for the given length
 * <code>n</code> and direction <code>dir</code> based
 on
 ...
 */
	...
	private native void createPlanSpecific( int n, int dir, int flags, double[] in, int idist, double[] out, int odist );
 ...
 * behind it is <code>fftw_one</code>.)
 ...
 * <p>(See FFTW documentation for details. The function
 * behind it is <code>fftw</code>, the arguments are
 * mapped to
 <code>fftw</code>'s arguments of the same name.)
 * @throws IndexOutOfBoundsException if <code>in</code>
 or <code>out</code>
